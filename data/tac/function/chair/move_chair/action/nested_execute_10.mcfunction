...
execute if block ~ ~-0.5 ~-0.4 minecraft:observer run function tac:chair/move_chair/action/nested_execute_9
...
execute unless score pressure_plate tac.main matches 0 run function tac:chair/move_chair/action/pressure_plate_north
