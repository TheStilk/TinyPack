execute if score #repeat_modify tac.main matches 1 run function tac:bench/modify_bench/action_south/bulk_action/nested_execute_0
...
execute if score @n[type=block_display, tag=tac, distance=..0.5] tac.main matches 0 run scoreboard players add @s tac.main 4
execute if score @n[type=block_display, tag=tac, distance=..0.5] tac.main matches 1 run rotate @n[type=block_display, tag=tac, distance=..0.5] -4 ~
...
execute store result entity @n[type=block_display, tag=tac, distance=..0.5] Rotation[0] float 1 run scoreboard players get @n[type=block_display, tag=tac, distance=..0.5] tac.main
execute store success score @n[type=block_display, tag=tac, distance=..0.5] tac.main run data modify entity @n[type=block_display, tag=tac, distance=..0.5] Rotation[0] set from entity @n[type=item_display, tag=bench, distance=..0.5] Rotation[0]
execute if score @n[type=block_display, tag=tac, distance=..0.5] tac.main matches 0 run scoreboard players add @s tac.main 8
execute if score @n[type=block_display, tag=tac, distance=..0.5] tac.main matches 1 run rotate @n[type=block_display, tag=tac, distance=..0.5] -8 ~
kill @n[type=block_display, tag=tac, tag=secondary, distance=..0.5]
scoreboard players reset @n[type=block_display, tag=tac, distance=..0.5]
execute if entity @s[type=block_display, tag=tac] run summon minecraft:block_display ~ ~ ~ {Tags: ["tac", "secondary"]}
