execute if score #repeat_modify tac.main matches 1 run function tac:bench/modify_bench/action_west/bulk_action/nested_execute_0
...
execute if score @n[type=block_display, tag=tac, distance=..0.5] tac.main matches 0 run scoreboard players add @s tac.main 32
execute if score @n[type=block_display, tag=tac, distance=..0.5] tac.main matches 1 run rotate @n[type=block_display, tag=tac, distance=..0.5] -32 ~
